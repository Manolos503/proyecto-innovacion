    ...
    public function index()
    {
        $faqs = [
            ...
            [
                ...
                "answer" => "No. En caso de error, deberá contactar al administrador del test.",
            ],
            [
            ...
            [
                ...
                "answer" => "No, el test no tiene límite de tiempo, pero te recomendamos hacer tu evaluación en un ambiente cómodo y sin distracciones.",
            ],
            [
                "question" => "¿A quién debo contactar si tengo algún problema?",
                "answer" => "Si tienes algún problema, puedes escribir al administrador del test: 'neftalihrramos@gmail.com'.",
            ],
            [
